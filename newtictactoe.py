...
class TicTacToeApp(App):
    ...
    def build(self):
        ...
        textInput = TextInput(id='text')
        pushButton = Button(text='Selected',
                            on_press=self.new_on_press(textInput.text))

        inputBoxLayout = BoxLayout(orientation='vertical')
        inputBoxLayout.add_widget(textInput)
        inputBoxLayout.add_widget(pushButton)
        ...
        root.add_widget()
        root.add_widget(inputBoxLayout)
