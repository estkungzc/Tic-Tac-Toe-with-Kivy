...
class TicTacToeApp(App):
    ...
    def build(self):
        ...
        self.board = [[None for col in range(self.cols)] for row in range(self.rows)]  # สร้างตารางซึ่งเป็น array 2 มิติ สำหรับเก็บ x,o ไว้
        print(self.board)
    ...
    def game_check(self):
        val = [[col.text for col in row] for row in self.board] #get x,o value from board
